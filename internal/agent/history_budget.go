...
//	32000 < window ≤ 256000 → window / 8
//	window > 256000  → 32000  (cap so big-cloud models don't drown the
...
//
//   - On a 1M+ model, naive window/8 = 125k tokens of old turns is
//     pure noise: a model with that much context already has plenty
//     for the current turn. 32k leaves room for ~80 typical turns and
