...
func StartRuntime(ctx context.Context, opts ...Option) (*Runtime, error) {
	...
	runner, toolReg, swarmRunner, sddRunner, mcpMgr, snapSvc, jobMgr, err := buildAgentRunner(workCtx, cfg, state, database, projectID, skillIndex, dataDir, runOpts.additionalDirs, jobBroker)
