...
var catppuccinMocha256 = Theme{
	...
	StatusError:     lipgloss.Color("217"),
	StatusWarning:   lipgloss.Color("215"),
	StatusSuccess:   lipgloss.Color("150"),
...
var warmSunsetLight256 = Theme{
	...
	BorderMuted:     lipgloss.Color("242"),
	FGEmphasis:      lipgloss.Color("235"),
	BGBase:          lipgloss.Color("255"),
	BGSurface:       lipgloss.Color("253"),
	BGOverlay:       lipgloss.Color("251"),
	BGSelection:     lipgloss.Color("252"),
	AccentPrimary:   lipgloss.Color("130"),
	AccentSecondary: lipgloss.Color("125"),
	AccentTertiary:  lipgloss.Color("94"),
	UserPrompt:      lipgloss.Color("240"),
	StatusError:     lipgloss.Color("124"),
	StatusWarning:   lipgloss.Color("94"),
	StatusSuccess:   lipgloss.Color("22"),
	StatusInfo:      lipgloss.Color("24"),
}
...
var draculaLight256 = Theme{
	...
	BGOverlay:       lipgloss.Color("251"),
	BGSelection:     lipgloss.Color("252"),
	AccentPrimary:   lipgloss.Color("125"),
	AccentSecondary: lipgloss.Color("57"),
	AccentTertiary:  lipgloss.Color("58"),
	UserPrompt:      lipgloss.Color("240"),
	StatusError:     lipgloss.Color("124"),
	StatusWarning:   lipgloss.Color("94"),
	StatusSuccess:   lipgloss.Color("22"),
...
var nordLight256 = Theme{
	...
	BGOverlay:       lipgloss.Color("251"),
	BGSelection:     lipgloss.Color("252"),
	AccentPrimary:   lipgloss.Color("25"),
	AccentSecondary: lipgloss.Color("24"),
	AccentTertiary:  lipgloss.Color("94"),
	UserPrompt:      lipgloss.Color("23"),
	StatusError:     lipgloss.Color("124"),
	StatusWarning:   lipgloss.Color("94"),
	StatusSuccess:   lipgloss.Color("22"),
	StatusInfo:      lipgloss.Color("90"),
}
...
var catppuccinLatte256 = Theme{
	...
	BGOverlay:       lipgloss.Color("251"),
	BGSelection:     lipgloss.Color("252"),
	AccentPrimary:   lipgloss.Color("19"),
	AccentSecondary: lipgloss.Color("25"),
	AccentTertiary:  lipgloss.Color("94"),
	UserPrompt:      lipgloss.Color("54"),
	StatusError:     lipgloss.Color("124"),
	StatusWarning:   lipgloss.Color("94"),
	StatusSuccess:   lipgloss.Color("22"),
	StatusInfo:      lipgloss.Color("23"),
}
