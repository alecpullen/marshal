...
const (
	...
	prefixWidth  = 8  // "exec    " / "critic  " / "marshal " / "        "
)
...
var (
	...
	stylePrefixMarshal = lipgloss.NewStyle().
				Foreground(colBl).
				Bold(true).
				Width(prefixWidth)
...
var (
	...
	styleStatusMarshal = lipgloss.NewStyle().Foreground(colBl)
	styleStatusExec    = lipgloss.NewStyle().Foreground(colTx2)
